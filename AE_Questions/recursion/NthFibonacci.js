/*
Nth Fibonacci
The Fibonacci sequence is defined as follows: first number of the sequence is 0, the 2nd number is 1, and the
nth number is the sum of the (n - 1)th and (n - 2)th numbers.  Write a function that takes in an integer n
